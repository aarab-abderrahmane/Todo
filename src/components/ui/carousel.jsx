...
function CarouselNavigation({
  ...
  return (
    <div
      className={cn(
        'pointer-events-none absolute left-[-12.5%] top-1/2 flex w-[125%] -translate-y-1/2 justify-between ',
        className
      )}>
      <button
        type='button'
        ...
        className={cn(
          'pointer-events-auto h-fit w-fit rounded-full bg-zinc-50 p-2 transition-opacity duration-300 bg-[var(--color-text)] ',
          alwaysShow
            ? 'opacity-100'
